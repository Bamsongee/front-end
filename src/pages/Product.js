        ...
        <div className="page">
            <div className="productBox">
                <div className="DetailPage-title">
                    <div className="DetailPage-title-des productTitleCenter">{username}님에게만 드리는</div>
                    <div className="DetailPage-title-name productTitleCenter">🔥핫딜특가🔥</div>
                </div>
                ...
                <div className="productItem">
                    {products.map((product) => (
                        <ProductItem
                            ...
                            discountedPrice={calculateDiscountedPrice(product.price, product.percent)}
                            url={product.url}
                        />
                    ))}
                </div>
